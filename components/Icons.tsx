...
export const UsersIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.57-.063 1.14-.095 1.722-.095m-4.522 0A18.06 18.06 0 0 1 5.166 5.166m10.666 0A18.06 18.06 0 0 1 18.834 15.834m-12.017 0c-.31.145-.614.305-.91.483m10.233-11.277c.31-.145.614-.305.91-.483M5.166 5.166c.31-.145.614-.305.91-.483m0 0a8.997 8.997 0 0 1 11.233 0m11.233 0c.31.145.614.305.91.483m0 0a8.997 8.997 0 0 1-11.233 0M12 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm12 6.375a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);
...
export const ShoppingCartIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.823-6.831a.75.75 0 0 0-.67-1.038H6.168M7.5 14.25 5.106 5.162M18 10.5h.008v.008H18V10.5Z" />
    </svg>
);
...
export const ArrowTrendingUpIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
